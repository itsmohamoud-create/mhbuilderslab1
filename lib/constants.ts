...
export const PROJECTS: Project[] = [
  {
    ...
    longDesc: "Full property agency website with MLS-style listings, appointment booking, local SEO, and a custom lead capture funnel.",
  },
  {
    id: "shiftsync",
    icon: "📱",
    ...
    longDesc: "Custom React Native + Next.js web app handling shift scheduling, availability tracking, and automated WhatsApp notifications.",
  },
  {
    id: "fitflow",
    icon: "🎯",
    ...
    longDesc: "Complete paid media strategy: Meta ads, landing page optimisation, email follow-up sequence. Achieved .20 ROAS in month one.",
  },
  {
    id: "retailpulse",
    icon: "🤖",
    ...
    longDesc: "n8n + OpenAI automation that monitors stock levels, predicts reorder points, and automatically raises purchase orders.",
  },
  {
    id: "serviceflow",
    icon: "⚡",
    ...
    longDesc: "AI voice agent handles inbound calls, qualifies leads, books appointments, syncs to HubSpot, and triggers WhatsApp follow-up.",
  },
  {
    id: "aura",
    icon: "✨",
    ...
    longDesc: "Complete brand identity: logo, colour system, typography, brand guidelines, social templates, and website redesign.",
  },
]
...
export const TESTIMONIALS: Testimonial[] = [
  {
    ...
    quote: "MH Builders Lab transformed our online store. The automation alone saves us 15 hours a week. Revenue is up 3× since we started.",
  },
  {
    initials: "JK",
    name: "James K.",
    role: "Contractor, Nairobi",
    quote: "Finally, a team that understands construction businesses. Our site ranks #1 for 'contractors Nairobi' and leads come in daily.",
  },
  {
    initials: "PS",
    name: "Priya S.",
    role: "Business Coach, London",
    quote: "The course platform they built is incredible. I launched my first digital product and made back my investment in the first week.",
  },
  {
    initials: "JM",
    name: "James Mwangi",
    role: "Restaurant Owner, Mombasa",
    quote: "Online orders up 200% after the new website launched. The WhatsApp automation handles everything now.",
  },
  {
    initials: "JS",
    name: "Jamal Sayed",
    role: "Real Estate Agent, Dubai",
    quote: "Professional, fast, and they actually understand marketing. The lead system brings in 30+ qualified buyers every month.",
  },
  {
    initials: "AN",
    name: "Ayan Noor",
    role: "Healthcare CEO, Nairobi",
    quote: "Concept to launch in 3 weeks. The app handles 500+ appointments daily without a single issue.",
  },
]
